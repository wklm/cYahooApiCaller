...
int main(int argc, const char * argv[]) {
    try {
        ...
        std::cout << quote::getLatestQuotesCsv(company, {quote::QuoteType::symbol, quote::QuoteType::name, quote::QuoteType::lastTradePriceOnly, quote::QuoteType::lastTradeDate, quote::QuoteType::lastTradeTime, quote::QuoteType::open, quote::QuoteType::dayLow, quote::QuoteType::dayHigh, quote::QuoteType::dayRange, quote::QuoteType::dividendShare, quote::QuoteType::peRatio}) << std::endl;
        ...
        std::cout << quote::getHistoricalQuotesCsv(company, 2010, 4, 1, 2014, 4, 21, quote::RangeType::dividendsOnly) << std::endl;
